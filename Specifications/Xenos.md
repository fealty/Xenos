...
Implementations may provide additional input paths for source code without violating this specification provided the above conditions hold. These provisions are in addition to other error conditions implementations may encounter, such as malformed file names.
